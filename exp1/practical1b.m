%% 150 km MEDIUM (nominal-π) line model
...
L_km = 150;
Z = (r_per_km + 1j*x_per_km) * L_km;      % total series impedance
Y = 1j*(b_microS*1e-6) * L_km;            % total shunt admittance
